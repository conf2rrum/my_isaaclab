...
MICROWAVE_USD_PATH = "/home/lgc/Downloads/microwave.usd"
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        microwave_joint_pos = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg("object", joint_names=[MICROWAVE_DOOR_JOINT])},
        )
...
class TerminationsCfg:
    ...
    success = DoneTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("object", joint_names=[MICROWAVE_DOOR_JOINT]),
