...
class CabinetSceneCfg(InteractiveSceneCfg):
    ...
    microwave = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="/home/lgc/projects/IsaacLab/custom_assets/microwave_articulation.usd",
            activate_contact_sensors=False,

            # USD 안에 세팅이 좀 불안하면 여기서 덮어쓰기
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            ...
            # 문 닫힌 상태 joint 값
            joint_pos={
                "joint_revolute_l_0_abstract_0_1": 0.0,
            },
        ),
        actuators={
            "door": ImplicitActuatorCfg(
                joint_names_expr=["joint_revolute_l_0_abstract_0_1"],
                effort_limit_sim=40.0,
                stiffness=0.0,   # 처음엔 낮게
                damping=1.0,
            ),
        },
    )
